...
# Read data 
data = pd.read_csv(fp, delim_whitespace = True, index_col = 0,header=0, parse_dates= [0],)
...
# YOUR CODE HERE 3
selection.plot(x = 'DATE',y = 'TEMP_C', c = 'black', edgecolor= 'black',markersize = 3,figsize=(14,6))
